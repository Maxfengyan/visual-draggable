...
function calculateLeftTop(
  ...
  if (needLockProportion) {
    if (newWidth / newHeight > proportion) {
      newTopLeftPoint.x += Math.abs(
        newWidth - newHeight * proportion,
      );
      newWidth = newHeight * proportion;
    } else {
      newTopLeftPoint.y += Math.abs(
...
function calculateRightTop(
  ...
  if (needLockProportion) {
    if (newWidth / newHeight > proportion) {
      newTopRightPoint.x -= Math.abs(
        newWidth - newHeight * proportion,
      );
      newWidth = newHeight * proportion;
    } else {
      newTopRightPoint.y += Math.abs(
        newHeight - newWidth / proportion,
      );
      newHeight = newWidth / proportion;
    }
...
function calculateRightBottom(
  ...
  if (needLockProportion) {
    if (newWidth / newHeight > proportion) {
      newBottomRightPoint.x -= Math.abs(
        newWidth - newHeight * proportion,
      );
      newWidth = newHeight * proportion;
    } else {
      newBottomRightPoint.y -= Math.abs(
        newHeight - newWidth / proportion,
      );
      newHeight = newWidth / proportion;
    }
...
function calculateLeftBottom(
  ...
  if (needLockProportion) {
    if (newWidth / newHeight > proportion) {
      newBottomLeftPoint.x += Math.abs(
        newWidth - newHeight * proportion,
      );
      newWidth = newHeight * proportion;
    } else {
      newBottomLeftPoint.y -= Math.abs(
        newHeight - newWidth / proportion,
      );
      newHeight = newWidth / proportion;
    }
